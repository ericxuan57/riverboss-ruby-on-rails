...
(function() {
  this.module("RiverBoss", function() {
    return this.module("General", function() {
      ...
      this.initFixedBlocks = function() {
        var blocks, fixPosition, win;
        win = jQuery(window);
      ...
      this.init = function() {
        var errorGeoFunction, getCookie, setCookie, setGeoCookieAndRedirect;
        if (!this.initialized) {
        ...
        setGeoCookieAndRedirect = function(position) {
          var cookie_val;
          cookie_val = position.coords.latitude + "|" + position.coords.longitude;
          setCookie("lat_lng", escape(cookie_val), 2);
          return window.location.replace(document.URL);
        };
        errorGeoFunction = function(error) {
          $('#modal_content').html("");
        ...
        if (navigator && navigator.geolocation && $("#html5_geolocation").length && getCookie("lat_lng") === "") {
          ...
          $('.modal').fadeIn(200);
          return navigator.geolocation.getCurrentPosition(setGeoCookieAndRedirect, errorGeoFunction, {
      ...
      this.initOnce = function() {
        ...
        $(document).on("click", ".toggle_cfs_ft", function() {
          return $('.river_table .col2').toggleClass('tog');
        });
        return $(document).on("click", ".alert-close", function(e) {
          e.preventDefault();
          return $(this).closest('.alert').slideUp(500);
        });
      };
      return this.ready = function() {
        ...
        return $('.weather-forecast .col1').each(function() {
          if ($(this).find('a').text().indexOf("ight") > -1) {
            return $(this).next().addClass('night-weather');
          }
        });
      };
    });
